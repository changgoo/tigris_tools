...
from tigris_tools.refine_restart.convert import _particle_shape, refine_restart
...
"""
    ...
    assert (index.header.mesh_size.nx1, index.header.mesh_size.nx2, index.header.mesh_size.nx3) == (4, 4, 4)
